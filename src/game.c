...
void _setGameMsgStart(Game *this, char *msgStart) {
  sprintf(this->_msgStart, "%s", msgStart);
}
void _setGameMsgReset(Game *this, char *msgReset) {
  sprintf(this->_msgReset, "%s", msgReset);
}
...
void _setGameLabelScore(Game *this, char *labelScore) {
  sprintf(this->_labelScore, "%s", labelScore);
}
void _setGameStrScore(Game *this, char *strScore) {
  sprintf(this->_strScore, "%s", strScore);
}
