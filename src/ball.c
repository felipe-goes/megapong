...
void _moveBall(Ball *this) {
  ...
  if (this->_posX < player.getPosX(&player) + PLAYER_WIDTH &&
      this->_posX + this->_width > player.getPosX(&player)) {
...
// Setters
void _setBallPosX(Ball *this, int posX){
  this->_posX = posX;
}
void _setBallPosY(Ball *this, int posY){
  this->_posY = posY;
}
void _setBallVelX(Ball *this, int velX){
  this->_velX = velX;
}
void _setBallVelY(Ball *this, int velY){
  this->_velY = velY;
}
void _setBallWidth(Ball *this, int width){
  this->_width = width;
}
void _setBallHeight(Ball *this, int height){
  this->_height = height;
}

// Getters
int _getBallPosX(Ball *this){
  return this->_posX;
}
int _getBallPosY(Ball *this){
  return this->_posY;
}
int _getBallVelX(Ball *this){
  return this->_velX;
}
int _getBallVelY(Ball *this){
  return this->_velY;
}
int _getBallWidth(Ball *this){
  return this->_width;
}
int _getBallHeight(Ball *this){
  return this->_height;
}
